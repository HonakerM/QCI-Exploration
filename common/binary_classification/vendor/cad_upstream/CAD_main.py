# ---------------------------------------------------------------------------
# VENDORED THIRD-PARTY SOURCE — DO NOT EDIT
#
# Source:  https://github.com/JerryGao818/CAD/blob/main/CAD-main.py
# Paper:   "Semi-Supervised Anomaly Detection through Denoising-Aware
#           Contrastive Distance Learning"
# Commit:  b609f6d9e3849ce18e81e7d6da44923f98c2b12d  (2024-11-25)
# License: none declared by the upstream repository.
#
# The upstream file is reproduced verbatim below this header. The only change
# is this comment block; not a single code line has been altered, so the file
# diffs cleanly against upstream.
#
# The tail of the file (from `def parse_args():` onward) is upstream's
# command-line entrypoint, which parses argv and starts a training run at
# import time. `vendor/cad_upstream/__init__.py` therefore loads only the
# definitions above that line. To refresh this file, re-download it at a new
# commit and update the header — do not hand-edit the code.
# ---------------------------------------------------------------------------
